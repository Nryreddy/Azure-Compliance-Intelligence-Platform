...
* **Structured Auditing via Azure OpenAI**: Detects, categorizes, and scores compliance violations (`CRITICAL` vs. `WARNING`) and extracts exact textual evidence using structured JSON schemas powered by **Azure OpenAI (GPT-4o)**.
...
| **LLMs & Embeddings** | Azure OpenAI (GPT-4o, text-embedding-3-large) |
